...
/*Globally Used Values*/
	...
	/*~~General~~*/
		$T_DISABLED = "Currently Disabled";
		$T_WELCOME_MESSAGE = "Welcome to the Fast Track Sites Trouble Ticket System. Please Login to begin using the system.";
		$T_PLEASE = "Please";
		$T_ALL = "All";
		$T_TICKETS = "Tickets";
		$T_DISPLAY = "Display";
	...
	/*~~Errors~~*/
		...
		$T_TAKEN_EMAIL_ADDRESS = "The email address you have selected has already been used by another member in our database.";
		$T_FIX_ERRORS = "Please fix the following errors:";
		$T_CREATION_ERROR = "There has been an error creating your account. Please contact the webmaster.";
		$T_PASSWORD_POLICY = "Your password must be more than 6 characters and not be \'password\' or the same as your username.";
...
/*Values for config.php*/
	...
	$T_ADD_PCAT = "Create Problem Category";
	$T_EDIT_PCAT = "Edit Problem Category";
	$T_DELETE_PCAT = "Delete Problem Category";
...
/*Values for viewticket.php*/
	$T_VIEW_TICKET = "View Ticket";
	$T_TICKET_ENTRIES = "Ticket Entries";
