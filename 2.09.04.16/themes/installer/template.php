...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
	<head>
		<title>Fast Track Sites Installer - <?php $page->printTemplateVar("PageTitle");  ?></title>
		...
		<div id="container">
			<div id="page">
				...
				<div id="content">
					<div id="leftCol">
						<ul id="steps">
							<li<?php if ($actual_step == 1) { echo " class=\"current\""; } ?>>1. Introduction</li>
							<li<?php if ($actual_step == 2) { echo " class=\"current\""; } ?>>2. Database Connection</li>
							<li<?php if ($actual_step == 3) { echo " class=\"current\""; } ?>>3. Create Databse Tables</li>
							<li<?php if ($actual_step == 4) { echo " class=\"current\""; } ?>>4. Create Admin Account</li>
							<li<?php if ($actual_step == 5) { echo " class=\"current\""; } ?>>5. Finish</li>
						</ul>
					</div>
					<div id="rightCol">
